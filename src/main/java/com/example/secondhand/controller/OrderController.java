...
import com.example.secondhand.dto.model.OrderResponseDto;
...
public class OrderController {
    ...
    @PostMapping("/create")
    public void saveOrder(@RequestBody CreateOrderRequest request) {
    ...
    */
    ...
    public ResponseEntity<List<OrderResponseDto>> findOrdersByCustomerId(@PathVariable String id) {
